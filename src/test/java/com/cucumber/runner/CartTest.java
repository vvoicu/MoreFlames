...
@CucumberOptions(features = { "src/test/resources/features/navigation/VerifyIfPagesLoadM.feature" }, glue = { "com.cucumber.stepdefinitions" }, plugin = { "com.sitture.ExtentFormatter" })
